...
export default function FeaturesSectionFr() {
  const features = [
    {
      icon: Search,
      title: "Recherche et Comparaison Intelligentes",
      description: "Trouvez les meilleures offres dans tous les supermarchés de Maurice grâce à notre recherche intelligente",
    ...
    },
    {
      ...
      description: "Sauvegardez les offres que vous aimez et ne ratez jamais vos produits préférés",
    ...
    },
    {
      ...
      description: "Filtrez les offres par catégorie, magasin ou fourchette de prix pour trouver exactement ce qu'il vous faut",
      creole: "Filtre malin",
      emoji: "🎯",
      screenshot: "/images/app-screenshot-2.jpg",
