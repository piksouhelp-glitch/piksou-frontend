...
export default function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden hero-gradient min-h-screen flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16 md:pt-32 md:pb-24 relative flex-1 flex items-center">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex items-center space-x-4 text-palm-shadow dark:text-gray-300">
                <p className="text-lg">
                  <span className="font-bold handwritten text-palm-shadow text-2xl">10,000+</span> Mauritians already saving!
              ...
              <div className="relative w-full h-full">
                ...
                <div className="relative w-full h-full">
                  ...
                  <div className="absolute top-2 left-1/2 transform -translate-x-1/2 z-20">
                    <div className="w-[260px] h-[370px] bg-gradient-to-br from-sugarcane-green to-ocean-blue rounded-3xl p-4 organic-card shadow-2xl">
                      <div className="bg-white rounded-2xl h-full p-3 shadow-lg overflow-hidden">
                        <div className="flex items-center justify-center mb-3">
                          <h3 className="text-sm font-bold text-gray-800">PikSou App</h3>
                        </div>
                        <div className="relative h-[calc(100%-2rem)]">
                          <img
                            src="/images/app-screenshot-1.jpg"
                            alt="PikSou app showing grocery deals comparison"
                  ...
                  <div className="absolute top-16 -left-16 z-10 transform rotate-[-8deg]">
                    <div className="w-[240px] h-[330px] bg-gradient-to-br from-mango-yellow to-sunset-orange rounded-2xl p-3 organic-card shadow-xl">
                      <div className="bg-white rounded-xl h-full p-2 shadow-lg overflow-hidden">
                        <div className="flex items-center justify-center mb-2">
                          <h3 className="text-xs font-bold text-gray-800">Deals</h3>
                        </div>
                        <div className="relative h-[calc(100%-1.5rem)]">
                          <img
                            src="/images/app-screenshot-2.jpg"
                            alt="PikSou app deals view"
                            className="w-full h-full object-cover rounded-lg"
                          />
                        </div>
                      </div>
                  ...
                  <div className="absolute top-20 -right-16 z-10 transform rotate-[6deg]">
                    <div className="w-[240px] h-[330px] bg-gradient-to-br from-ocean-blue to-sugarcane-green rounded-2xl p-3 organic-card shadow-xl">
                      <div className="bg-white rounded-xl h-full p-2 shadow-lg overflow-hidden">
                        <div className="flex items-center justify-center mb-2">
                          <h3 className="text-xs font-bold text-gray-800">Compare</h3>
                        </div>
                        <div className="relative h-[calc(100%-1.5rem)]">
                          <img
                            src="/images/app-screenshot-3.jpg"
                            alt="PikSou app comparison view"
                            className="w-full h-full object-cover rounded-lg"
                          />
                        </div>
                      </div>
