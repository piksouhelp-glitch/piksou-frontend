...
export default function ValuePropositionStripFr() {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                    ...
                    >
                        ...
                        >
                            Comparez les prix dans tous les supermarchés et trouvez les meilleures offres
                        </motion.p>
                    </motion.div>

                    {/* Trouvez des Offres Rapidement */}
                    <motion.div
                        className="flex flex-col items-center text-center space-y-3 cursor-pointer group"
                        initial={{ opacity: 0, y: 20 }}
                        animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
                    ...
                    >
                        ...
                        >
                            Accédez instantanément aux dernières promotions et réductions
                        </motion.p>
                    </motion.div>
                    ...
                    >
                        ...
                        >
                            Surveillez combien vous économisez à chaque course
                        </motion.p>
                    </motion.div>
                </div>
            </div>
