...
export default function PartnersPageLogos({ locale = "en" }: PartnersPageLogosProps) {
  ...
  return (
    <section className="py-16 md:py-12 -mt-24 md:-mt-32 relative z-20 transition-colors duration-300 overflow-hidden bg-gradient-to-b from-white/90 via-white to-white dark:from-gray-900/90 dark:via-gray-900 dark:to-gray-900">
